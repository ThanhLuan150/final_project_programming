...
if (isset($_SESSION['username'])) {
  ...
  // Thêm nút đăng xuất
  echo "<a href='../views/Dangxuat.view.php'>Đăng xuất</a>";
} else {
        ...
        while ($row = mysqli_fetch_assoc($query)) { ?>
          <tr>
            ...
            <td>
              ...
              <a onclick="return confirm ('bạn có muốn xóa sinh viên này không');" href="admindelete.php?id=<?php echo $row['id_clothes']; ?>" class="btn btn-danger">xóa
            </td>
          </tr>
        <?php } ?>
      </tbody>
        ...
        <div class="modal-body">
          <form action="add.php" method="post">
            <div class="form-group">
              <label for="name_clothes"></label>name_clothes<input type="text" id="name_clothes" class="form-control" name="name_clothes">
            </div>
            <div class="form-group">
              <label for="image"></label>image<input type="text" id="image" class="form-control" name="image">
            </div>
            <div class="form-group">
              <label for="rent_prices"></label>rent_prices<input type="text" id="rent_prices" class="form-control" name="rent_prices">
            </div>
            <div class="form-group">
              <label for="tiencoc"></label>tiencoc<input type="text" id="tiencoc" class="form-control" name="tiencoc">
            </div>
            <div class="form-group">
              <label for="name_categories"></label>name_categories<input type="text" id="name_categories" class="form-control" name="name_categories">
            </div>
            <div class="form-group">
              <label for="created_at"></label>created_at<input type="text" id="created_at" class="form-control" name="created_at">
            </div>
            <div class="form-group">
              <label for="updated_at"></label>updated_at<input type="text" id="updated_at" class="form-control" name="updated_at">
            </div>
